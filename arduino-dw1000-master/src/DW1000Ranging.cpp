...
float DW1000RangingClass::getXLocation(uint16_t LID, float Dis) {
	float x1 = 0;
	float x2 = 10;
	float x3 = 10;
	float y1 = 0;
	...
	if (LID == 0000) d1 = Dis;
	else if (LID == 0001) d2 = Dis;
	else  d3 = Dis;

	x= (pow(d1, 2) - pow(d2, 2) + pow(x2, 2)) / (2 * x2);
	return x;

}

float DW1000RangingClass::getYLocation(uint16_t LID, float Dis) {
	float x1 = 0;
	float x2 = 10;
	float x3 = 10;
	float y1 = 0;
	...
	y = ((pow(d2, 2) - pow(d3, 2) + pow(y3, 2)) / (2 * y3)) - ((2 * x3 - 2 * x2) * (pow(d1, 2) - pow(d2, 2) + pow(x2, 2))) / (4 * x2 * y3);
